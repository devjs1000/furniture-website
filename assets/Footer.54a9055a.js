import { j as c, a as e } from "./index.0967a299.js";
import "./vendor.cfa9d7b1.js";
function s() {
  return c("footer", {
    children: [
      e("div", {
        ...
        children: c("div", {
          className:
            "max-w-6xl m-auto text-gray-800 flex flex-wrap justify-center",
          children: [
            c("div", {
              className: "p-5 w-48 ",
              children: [
                ...
                c("a", {
                  ...
                  children: [
                    "Services ",
                    e("span", { className: "text-teal-600 text-xs p-1" }),
                  ],
                }),
                c("a", {
                  className: "my-3 block",
      ...
      e("div", {
        ...
        children: c("div", {
          className:
            "flex pb-5 px-3 m-auto pt-5 border-t text-gray-800 text-sm flex-col md:flex-row max-w-6xl",
          children: [
            e("div", {
              className: "mt-2",
            ...
            c("div", {
              ...
              children: [
                e("a", {
                  ...
                  children: e("svg", {
                    className:
                      "fill-current cursor-pointer text-gray-500 hover:text-gray-400",
                    width: "100%",
                    height: "100%",
                    viewBox: "0 0 24 24",
                    version: "1.1",
